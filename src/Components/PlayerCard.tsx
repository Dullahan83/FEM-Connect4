...
const PlayerCard = ({
    ...
    return (
        <div
            className={`w-35.5 relative flex items-center justify-center rounded-[20px] border-[3px] border-black bg-white py-2.5 shadow-[0_10px_0_0_#000] sm:p-0 lg:-mt-[17px] lg:h-40  lg:flex-col lg:pt-11 ${props.className}`}
        >
            {player === 'red' ? (
            ...
            <p className=" text-Heading-XS sm:text-Heading-S">
