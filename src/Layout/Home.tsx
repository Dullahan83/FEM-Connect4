...
const Home = () => {
    ...
    return (
        <div className=" bg-purple sm:bg-darkPurple relative flex h-full w-full flex-col items-center justify-center">
            <MenuContainer className="sm:bg-purple sm:shadow-container sm:pb-15 -mt-13 w-full border-none bg-transparent px-5 py-0 shadow-none sm:-mt-0 sm:border-[3px] sm:border-solid sm:border-black sm:px-10 sm:pt-[70px]">
